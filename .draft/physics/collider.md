...
- [physics-server.md](physics-server.md) — Server that reads Collider and calls backend.AddCollider
...
### 2.2 Model B — Child Entity (hierarchical)
...
| :--- | :--- | :--- |
| 0.1.0 | 2026-03-27 | Initial draft — both architectural models analysed, Model B (child entity) recommended, full shape set, collision groups, lifecycle hooks |
